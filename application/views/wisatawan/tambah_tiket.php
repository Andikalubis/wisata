                    ...
                    <?php foreach($detail as $dt) : ?>
                      <form method="POST" action="<?php echo base_url('wisatawan/tambah_tiket_aksi') ?>">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          ...
                          <input class="stext-115 cl2 plh3 size-116 p-l-62 p-r-30" type="text" class="form-control" name="harga_tiket" value="<?php  echo $dt->harga_tiket ?>" readonly>
                        </div>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          ...
                          <input class="stext-115 cl2 plh3 size-116 p-l-62 p-r-30" name="tgl_order" value="<?php echo $currentDateTime; ?>" readonly>
                        </div>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          <input class="stext-115 cl2 plh3 size-116 p-l-62 p-r-30" type="date" name="tgl_booking">
                        </div>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          <input class="stext-115 cl2 plh3 size-116 p-l-62 p-r-30" type="time" name="waktu" step="1">
                        </div>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          <input class="stext-115 cl2 plh3 size-116 p-l-62 p-r-30" type="number" name="jumlah_tiket">
                        </div>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          <input class="stext-115 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="no_hp">
                        </div>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          <input class="stext-115 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="alamat_wisatawan">
                        </div>
